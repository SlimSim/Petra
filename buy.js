...
purchaseSuccess = function(e){
  $('#currentWorkout').text("Thank you!")
  $('#currentExercise').text("Thank you so much!")
}

purchaseFail = function(e){
  $('#currentWorkout').text("Well, thanks for the consideration!")
  $('#currentExercise').text("Hope you enjoy Petra!")
}
...
purchase = function(){
  ...
  function addProductToUI(product) {
    ...
    var butAct = $("<input value='" + product.localeData[0].title + "' type='button'></input>")
  ...
  var onSkuDetailsFail = function(a){
    $('#currentWorkout').text("Can not reach Google-wallet at the moment.")
    closeDonateDialog();
    return; /*
